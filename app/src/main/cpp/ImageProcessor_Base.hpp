...
// 새 모드에서 사용할 ImageComparator 버전에 대한 헤더 파일 include하기
#include "ImageComparator_Base.hpp"

// 새 모드에서 사용할 ImageEvaluator 버전에 대한 헤더 파일 include하기
		...
		struct ImageProcessor<-1> : ImageProcessor_Base
		{
			/*
				...
				- 노트해 둔 내용을 바탕으로, 각 파일들에 담긴 다른 버전 정의들을 참고하면서
				  새 모드의 동작에 필요한 멤버 선언 및 정의 작성하기. 필요시 새 ImageComparator 등을 정의해 사용하기.
